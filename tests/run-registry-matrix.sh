...
Defaults:
  PUSH_ROOT_URL = https://bin2.nthesis.ai
  PULL_ROOT_URL = https://bin2-pull.nthesis.ai
...
push_root_url="${1:-https://bin2.nthesis.ai}"
pull_root_url="${2:-https://bin2-pull.nthesis.ai}"
